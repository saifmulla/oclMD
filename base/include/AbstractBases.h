...
class CalculateForcesAndEnergyBase : public BaseImpl{
public:
    /// function returning the name of the class as string
    static std::string className(){
        return "CaluateForcesAndEnergyBase";
    }
    
    /// constructor initialising BaseImpl
    CalculateForcesAndEnergyBase(const Platform& platform, std::string classname)
...
class DataBase : public BaseImpl {
public:
    static std::string className(){
        return "DataBase";
    }
    
    DataBase(const Platform& platform, std::string classname) : BaseImpl(platform,classname){
